<div class="tv__container" id="faq">
    <div class="faq__container">
        <h1 class="faq__title">Frequemtly Asked Questions</h1>
        <div class="faq__list">
            <div class="faq__list_item">
                <button class="main__list_bar" onclick="toggleExpand(1)">
                    <h1 class="faq__list_title">What is Netflix?</h1>
            ...
            <div class="faq__list_item">
                <button class="main__list_bar" onclick="toggleExpand(2)">
                    <h1 class="faq__list_title">How much does Netflix cost?</h1>
            ...
            <div class="faq__list_item">
                <button class="main__list_bar" onclick="toggleExpand(3)">
                    <h1 class="faq__list_title">Where can I watch?</h1>
            ...
            <div class="faq__list_item">
                <button class="main__list_bar" onclick="toggleExpand(4)">
                    <h1 class="faq__list_title">How do I cancel?</h1>
            ...
            <div class="faq__list_item">
                <button class="main__list_bar" onclick="toggleExpand(5)">
                    <h1 class="faq__list_title">What can I watch on Netflix?</h1>
            ...
            <div class="faq__list_item">
                <button class="main__list_bar" onclick="toggleExpand(6)">
                    <h1 class="faq__list_title">Is Netflix good for kids?</h1>
